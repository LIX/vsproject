...
namespace ChartDirectorSampleCode
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void initChartViewer(WPFChartViewer viewer)
        {
            ...
            viewer.ViewPortChanged += WPFChartViewer1_ViewPortChanged;
            viewer.MouseMovePlotArea += WPFChartViewer1_MouseMovePlotArea;

            // Connect the viewport control to the chart viewer
            viewPortControl1.Viewer = viewer;
        ...
        //
        private void drawFullChart(WPFViewPortControl vpc)
        {
